...
public class BOJ_14888_연산자_끼워넣기_심화 {
    static int N, max, min;
    static int[] nums, operators, order;
    static BOJ_14888_연산자_끼워넣기.FastReader scan = new BOJ_14888_연산자_끼워넣기.FastReader();
    ...
    private static int calculator(int value, int cand, int num) {
        if (cand == 1)
            return value + num;
        else if (cand == 2)
            return value - num;
